...
1.  `fade-out`, start visible and fade out 1 . there is also `-up`, `-down`, `-left`, `-right`, `-in-then-semi-out`
...
2.  I was having trouble with my output codes, trying to make it do different things such as having `output-location: fragment` or slide or anything
